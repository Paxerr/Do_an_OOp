...
public class ManagerDashBoardController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("Sửa giá")) {
            ...
            String TicketType = MD.CostTypeCombo.getSelectedItem().toString();
            String Type = MD.CostTypeVehicleCombo.getSelectedItem().toString();
            int Cost = Integer.parseInt(Coststr);
            switch (TicketType) {
                case ("Vé Tháng"):
                    if (Type.equals("Xe máy")) {
                        MonthlyTicketMotobike t = null;
                        t.setCost(Cost);

                    }
                    if (Type.equals("Ô tô")) {
                        MonthlyTicketCar t = null;
                        t.setCost(Cost);

                    }
                    if (Type.equals("Xe đạp")) {
                        MonthlyTicketBicycle t = null;
                        t.setCost(Cost);
