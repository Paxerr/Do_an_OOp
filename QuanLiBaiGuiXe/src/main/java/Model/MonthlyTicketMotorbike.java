 ...
 * @author Moderator
 */
public class MonthlyTicketMotorbike extends ParkingTicket {
    public  MonthlyTicketMotorbike(){
    ...
    public void setCost1(){
        ...
        try{
            ...
            KetQuaTruyVan.next();
            String a = KetQuaTruyVan.getInt("MonthlyMotorbike") + "";
            if(KetQuaTruyVan.wasNull())
                this.Cost1 = -1;
            else{
                this.Cost1 = KetQuaTruyVan.getInt("MonthlyMotorbike");
            }
    ...
    public void setCost1(int Cost) {
        ...
        try {
            ...
            if (KetQuaTruyVan.next()) {
                String SuaGia = "UPDATE cost SET MonthlyMotorbike = ?  WHERE STT = ?";
                ...
                String ThemGia = "INSERT INTO cost ( STT, MonthlyMotorbike) VALUES (? , ?)";
