 ...
 * @author Moderator
 */
public class TicketBicycle extends ParkingTicket {
    public  TicketBicycle(){
    ...
    public void setCapacity(){
        ...
        try{
            ...
            if (!KetQuaTruyVan.next()) {
                ...
                this.Capacity = KetQuaTruyVan.getInt("CapacityBicycle");
    ...
    public void setCapacity(int Capacity) {
        ...
        try {
            ...
            KetQuaTruyVan = state.executeQuery();
            if (KetQuaTruyVan.next()) {
                String SuaCapacity = "UPDATE setting SET CapacityBicycle = ?  WHERE STT = ?";
                ...
                String ThemCapacity = "INSERT INTO setting (STT, CapacityBicycle) VALUES (? , ?)";
    ...
    public void setCost1(int Cost) {
        ...
        try {
            ...
            KetQuaTruyVan = state.executeQuery();
            if (KetQuaTruyVan.next()) {
                String SuaGia = "UPDATE setting SET Bicycle = ?  WHERE STT = ?";
                ...
                String ThemGia = "INSERT INTO cost ( STT, Bicycle) VALUES (? , ?)";
